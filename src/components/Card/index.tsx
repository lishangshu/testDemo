...
const Card: FC<CardProps> = ({ logo, subLogo, title, apy, version, pid, maturity, cycle, contractAddress }) => {
  return (
    <div className="bg-white text-black p-4 rounded-lg shadow-lg border border-gray-300 w-400">
      ...
      <div className="flex justify-center">
        <Link href={`/asset?pid=${pid}&apy=${apy}&maturity=${maturity}&cycle=${cycle}&contractAddress=${contractAddress}`}>
